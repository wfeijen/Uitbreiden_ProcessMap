...
agregationInst = list(enriched_column_aggregate( FUN = max, columnNameIn = "RandomWaarde1", columnNameOut = "xxx1", edgeOperation = "plus"),enriched_column_aggregate( FUN = max, columnNameIn = "RandomWaarde2", columnNameOut = "xxx2", edgeOperation = "minus"),enriched_performance(FUN = mean, columnName = "perf")
                      )
map<-enriched_process_map(eventLog.Base, aggregationInstructions = agregationInst )
```
